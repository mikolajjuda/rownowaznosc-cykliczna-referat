...
\subsection{Algorytm}
Można użyć do tego dowolnego algorytmu wyszukiwania wzorca,
...
Wersja wykorzystująca algorytm Knutha-Morrisa-Pratta
wykonuje dla tego problemu około \(5n\) porównań\cite{shiloach1979}.
